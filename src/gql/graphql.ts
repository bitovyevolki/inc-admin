...
export type OnAddPostSubscriptionSubscription = {
  __typename?: 'Subscription'
  postAdded: {
    __typename?: 'Post'
    id: number
...
export const OnAddPostSubscriptionDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'subscription',
      name: { kind: 'Name', value: 'onAddPostSubscription' },
      selectionSet: {
        kind: 'SelectionSet',
        selections: [
          {
  ...
  OnAddPostSubscriptionSubscription,
...
export const GetUploadedFilesDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'getUploadedFiles' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: { kind: 'Variable', name: { kind: 'Name', value: 'userId' } },
...
} as unknown as DocumentNode<GetUploadedFilesQuery, GetUploadedFilesQueryVariables>
